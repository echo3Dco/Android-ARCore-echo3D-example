...
import com.google.ar.core.examples.java.helloar.Config;
...
public class ObjectRenderer {
  ...
  public void createOnGlThread(Context context, String objAssetName, String diffuseTextureAssetName)
    ...
    // Read the texture.
    Bitmap textureBitmap = (!Config.OFFLINE_MODE) ?
            BitmapFactory.decodeStream(new FileInputStream(CMS.getFile(diffuseTextureAssetName))) :
    ...
    // Read the obj file.
    InputStream objInputStream = (!Config.OFFLINE_MODE) ?
            new FileInputStream(CMS.getFile(objAssetName)) :
